...
<body>
    ...
    <script>
            ...
            fetch('get_announcements.php')
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        // Get approved announcements from myAnnouncements (admin's own published announcements)
        ...
        window.addEventListener('click', function(e) {
            ...
            if (e.target === createModal) { closeCreateAnnouncementModal(); }
            if (e.target === viewModal) { closeViewAnnouncementModal(); }
        });

        // Close modal when clicking outside (for announcement modal)
        window.addEventListener('click', function(e) {
